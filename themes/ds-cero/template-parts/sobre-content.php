...
<section class="w-full flex flex-col items-center justify-center gap-20 px-10 lg:px-20 2xl:px-40 py-10 lg:py-20 fondo-blanco overflow-x-hidden">
    ...
    <div class="w-full flex flex-col-reverse xl:flex-row-reverse items-center xl:items-end justify-center xl:justify-end gap-10 2xl:gap-20">
        <div id="sobre-imageblock-1" class="w-3/4 xl:w-1/2 flex flex-col sm:flex-row items-center justify-center gap-10 xl:gap-0">
            <div class="w-full sm:w-3/5 aspect-[16/9] bg-center bg-cover xl:-translate-y-40" style="background-image:url('<?= $imagen_1 ?>')"></div>
            <div class="w-full sm:w-2/5 aspect-[1/1] bg-center bg-cover xl:translate-y-12 xl:-translate-x-4" style="background-image:url('<?= $imagen_2 ?>')"></div>
        </div>
    ...
    <div class="w-full flex flex-col-reverse xl:flex-row items-center xl:items-end justify-center xl:justify-end gap-10 2xl:gap-20">
        <div id="sobre-imageblock-2" class="w-3/4 xl:w-1/2 flex flex-col sm:flex-row items-center justify-between gap-10 xl:gap-0">
            <div class="w-full sm:w-1/3 aspect-[9/16] bg-center bg-cover xl:translate-y-10" style="background-image:url('<?= $imagen_3 ?>')"></div>
            <div class="w-full sm:w-3/5 aspect-[1/1] bg-center bg-cover xl:-translate-y-10" style="background-image:url('<?= $imagen_4 ?>')"></div>
        </div>
    ...
    <div class="aspect-[1/1] p-6 xl:p-8 bg-black bg-opacity-60 w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 text-white duration-300 hover:bg-opacity-70 hover:backdrop-blur-xl hover:shadow-xl mt-10">
        <div class="border-[1px] border-white w-full h-full p-6 xl:p-8 xl:pl-10 2xl:pl-14 flex flex-col items-end justify-center gap-8 2xl:gap-10 text-end">
            <p class="font-agencyfb text-lg sm:text-xl 2xl:text-2xl uppercase font-bold"><?= $titulo_enlace ?></p>
