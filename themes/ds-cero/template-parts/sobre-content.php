...
<section class="w-full flex flex-col items-center justify-center gap-20 px-10 lg:px-20 2xl:px-40 py-10 lg:py-20 fondo-blanco overflow-x-hidden">
    ...
    <div class="w-full flex flex-col-reverse xl:flex-row-reverse items-center justify-center gap-10 2xl:gap-20">
    ...
    <div class="w-full flex flex-col-reverse xl:flex-row items-center justify-center gap-10 2xl:gap-20">
