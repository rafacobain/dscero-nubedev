...
<section class="w-full h-fit sm:h-screen flex items-center justify-center p-2 sm:p-6 xl:p-8  bg-white">
    <div class="w-full h-full bg-center bg-cover p-6 xl:p-8 flex flex-col items-center sm:items-end justify-start  py-20 sm:py-0" style="background-image:url('<?= $imagen_intro ?>')">
        <div class="aspect-[1/1] bg-white bg-opacity-40 w-80 xl:w-96 2xl:w-[25rem] text-black duration-300 hover:bg-opacity-50 hover:backdrop-blur-xl hover:shadow-xl">
            <div class=" w-full h-full p-6 xl:p-8 flex flex-col items-end justify-center gap-10 text-end">
                <p class="font-semibold text-base sm:text-lg 2xl:text-xl uppercase "><?= $titulo_intro ?></p>
