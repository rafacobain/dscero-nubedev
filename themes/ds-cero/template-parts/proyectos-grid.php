...
<section class="px-32 pt-20 pb-40 min-h-screen grid grid-cols-3 gap-x-40 gap-y-52 w-screen fondo-blanco">
    ...
    if ($proyectos_query->have_posts()) :
        ...
        while ($proyectos_query->have_posts()) :
            ...
            <a href="<?= get_the_permalink(); ?>" class="aspect-[1/1] p-8 bg-black bg-opacity-60 w-full text-white duration-300 hover:bg-opacity-70 hover:backdrop-blur-xl hover:shadow-xl relative">
