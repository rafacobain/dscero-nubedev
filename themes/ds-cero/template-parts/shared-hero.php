...
<section id="section-parallax" class="w-screen h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <div class="aspect-[1/1] p-6 xl:p-8 bg-black bg-opacity-60 w-2/3 sm:w-1/5 text-white duration-300 hover:bg-opacity-70 hover:backdrop-blur-xl hover:shadow-xl sm:absolute top-20 right-20">
        <div class="border-[1px] border-white w-full h-full p-6 xl:p-8 xl:pl-10 2xl:pl-14 flex flex-col items-end justify-center gap-8 2xl:gap-10 text-end">
            <p class="font-agencyfb text-lg sm:text-xl 2xl:text-2xl uppercase font-bold"><?= $titulo ?></p>
        </div>
    </div>
</section>