...
<section id="section-parallax" class="w-screen h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <div class="aspect-[1/1] p-8 bg-black bg-opacity-60 w-1/5 text-white duration-300 hover:bg-opacity-70 hover:backdrop-blur-xl hover:shadow-xl absolute top-20 right-20">
